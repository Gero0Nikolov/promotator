...
Tags: email, mailing, marketing, massmailing, globalmailer, messenger, assistant
...
By default Promotator comes with one built in template called: <strong>template-1.html</strong>; It can be found in the
plugin directory at the folder <strong>mailings</strong>.
